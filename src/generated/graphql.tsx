...
/** Who created or shared their plan trip */
...
export type MemberSavedPlansArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
...
export type MemberCreateInput = {
  clhgtvx4w0oo501t9azoz1inu?: InputMaybe<AuthorCreateManyInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  email: Scalars['String'];
...
export type MemberManyWhereInput = {
  ...
  publishedAt_not_in?: InputMaybe<Array<InputMaybe<Scalars['DateTime']>>>;
  publishedBy?: InputMaybe<UserWhereInput>;
  savedPlans_every?: InputMaybe<PlanWhereInput>;
  savedPlans_none?: InputMaybe<PlanWhereInput>;
  savedPlans_some?: InputMaybe<PlanWhereInput>;
  scheduledIn_every?: InputMaybe<ScheduledOperationWhereInput>;
  scheduledIn_none?: InputMaybe<ScheduledOperationWhereInput>;
  scheduledIn_some?: InputMaybe<ScheduledOperationWhereInput>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
...
export type MemberUpdateInput = {
  clhgtvx4w0oo501t9azoz1inu?: InputMaybe<AuthorUpdateManyInlineInput>;
  email?: InputMaybe<Scalars['String']>;
...
export type Mutation = {
  ...
  /**
   * Delete many Plan documents
   * @deprecated Please use the new paginated many mutation (deleteManyPlansConnection)
   */
  deleteManyPlans: BatchPayload;
  /** Delete many Plan documents, return deleted documents */
  deleteManyPlansConnection: PlanConnection;
  /** Delete one member from _all_ existing stages. Returns deleted document. */
  deleteMember?: Maybe<Member>;
  /** Delete one plan from _all_ existing stages. Returns deleted document. */
  ...
  /**
   * Publish many Plan documents
   * @deprecated Please use the new paginated many mutation (publishManyPlansConnection)
   */
  publishManyPlans: BatchPayload;
  /** Publish many Plan documents */
  publishManyPlansConnection: PlanConnection;
  /** Publish one member */
  ...
  /**
   * Unpublish many Plan documents
   * @deprecated Please use the new paginated many mutation (unpublishManyPlansConnection)
   */
  unpublishManyPlans: BatchPayload;
  /** Find many Plan documents that match criteria in specified stage and unpublish from target stages */
  unpublishManyPlansConnection: PlanConnection;
  /** Unpublish one member from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  ...
  /**
   * Update many plans
   * @deprecated Please use the new paginated many mutation (updateManyPlansConnection)
   */
  updateManyPlans: BatchPayload;
  /** Update many Plan documents */
  updateManyPlansConnection: PlanConnection;
  /** Update one member */
...
export type MutationDeleteManyPlansArgs = {
  where?: InputMaybe<PlanManyWhereInput>;
};


export type MutationDeleteManyPlansConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
export type MutationPublishManyPlansArgs = {
  to?: Array<Stage>;
  where?: InputMaybe<PlanManyWhereInput>;
};


export type MutationPublishManyPlansConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  first?: InputMaybe<Scalars['Int']>;
  from?: InputMaybe<Stage>;
...
export type MutationSchedulePublishPlanArgs = {
  releaseAt?: InputMaybe<Scalars['DateTime']>;
  releaseId?: InputMaybe<Scalars['String']>;
  to?: Array<Stage>;
  where: PlanWhereUniqueInput;
...
export type MutationScheduleUnpublishPlanArgs = {
  from?: Array<Stage>;
  releaseAt?: InputMaybe<Scalars['DateTime']>;
  releaseId?: InputMaybe<Scalars['String']>;
  where: PlanWhereUniqueInput;
...
export type MutationUnpublishManyPlansArgs = {
  from?: Array<Stage>;
  where?: InputMaybe<PlanManyWhereInput>;
};


export type MutationUnpublishManyPlansConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  first?: InputMaybe<Scalars['Int']>;
  from?: Array<Stage>;
...
export type MutationUnpublishPlanArgs = {
  from?: Array<Stage>;
  where: PlanWhereUniqueInput;
};
...
export type MutationUpdateManyPlansArgs = {
  data: PlanUpdateManyInput;
  where?: InputMaybe<PlanManyWhereInput>;
};


export type MutationUpdateManyPlansConnectionArgs = {
  after?: InputMaybe<Scalars['ID']>;
  before?: InputMaybe<Scalars['ID']>;
  data: PlanUpdateManyInput;
  first?: InputMaybe<Scalars['Int']>;
...
export type PlanAuthorArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
  locales?: InputMaybe<Array<Locale>>;
};


export type PlanCreatedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
  locales?: InputMaybe<Array<Locale>>;
};


export type PlanDocumentInStagesArgs = {
  includeCurrent?: Scalars['Boolean'];
  inheritLocale?: Scalars['Boolean'];
  stages?: Array<Stage>;
};
...
export type PlanPublishedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
  locales?: InputMaybe<Array<Locale>>;
};


export type PlanScheduledInArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
...
export type PlanUpdatedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
  locales?: InputMaybe<Array<Locale>>;
};

export type PlanConnectInput = {
  /** Allow to specify document position in list of connected documents, will default to appending at end of list */
  position?: InputMaybe<ConnectPositionInput>;
  /** Document to connect */
  where: PlanWhereUniqueInput;
...
export type PlanCreateInput = {
  ...
  clhhxvtbl1kuq01ulht0s2v33?: InputMaybe<MemberCreateManyInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  days: Scalars['Int'];
  expenses: Scalars['Json'];
...
export type PlanCreateManyInlineInput = {
  /** Connect multiple existing Plan documents */
  connect?: InputMaybe<Array<PlanWhereUniqueInput>>;
  /** Create and connect multiple existing Plan documents */
  create?: InputMaybe<Array<PlanCreateInput>>;
};

export type PlanCreateOneInlineInput = {
  /** Connect one existing Plan document */
  connect?: InputMaybe<PlanWhereUniqueInput>;
  /** Create and connect one Plan document */
...
/** Identifies documents */
export type PlanManyWhereInput = {
  /** Logical AND on all given filters. */
  ...
  /** All values that are contained in given list. */
  days_in?: InputMaybe<Array<InputMaybe<Scalars['Int']>>>;
  /** All values less than the given value. */
  ...
  /** All values that are not contained in given list. */
  days_not_in?: InputMaybe<Array<InputMaybe<Scalars['Int']>>>;
  documentInStages_every?: InputMaybe<PlanWhereStageInput>;
  documentInStages_none?: InputMaybe<PlanWhereStageInput>;
  documentInStages_some?: InputMaybe<PlanWhereStageInput>;
  /** All values containing the given json path. */
  expenses_json_path_exists?: InputMaybe<Scalars['String']>;
  /**
   ...
   */
  expenses_value_recursive?: InputMaybe<Scalars['Json']>;
  id?: InputMaybe<Scalars['ID']>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']>;
  /** All values ending with the given string. */
  ...
  scheduledIn_some?: InputMaybe<ScheduledOperationWhereInput>;
  /** All values containing the given json path. */
  transportation_json_path_exists?: InputMaybe<Scalars['String']>;
  /**
   * Recursively tries to find the provided JSON scalar value inside the field.
   * It does use an exact match when comparing values.
   * If you pass `null` as value the filter will be ignored.
   * Note: This filter fails if you try to look for a non scalar JSON value!
   */
  transportation_value_recursive?: InputMaybe<Scalars['Json']>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  updatedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export type PlanUpdateManyInlineInput = {
  /** Connect multiple existing Plan documents */
  connect?: InputMaybe<Array<PlanConnectInput>>;
  /** Create and connect multiple Plan documents */
  create?: InputMaybe<Array<PlanCreateInput>>;
  /** Delete multiple Plan documents */
  delete?: InputMaybe<Array<PlanWhereUniqueInput>>;
  /** Disconnect multiple Plan documents */
  disconnect?: InputMaybe<Array<PlanWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing Plan documents */
  set?: InputMaybe<Array<PlanWhereUniqueInput>>;
  /** Update multiple Plan documents */
  update?: InputMaybe<Array<PlanUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple Plan documents */
  upsert?: InputMaybe<Array<PlanUpsertWithNestedWhereUniqueInput>>;
};
...
export type PlanUpdateManyWithNestedWhereInput = {
  /** Update many input */
  data: PlanUpdateManyInput;
  /** Document search */
...
export type PlanUpdateOneInlineInput = {
  /** Connect existing Plan document */
  connect?: InputMaybe<PlanWhereUniqueInput>;
  /** Create and connect one Plan document */
  create?: InputMaybe<PlanCreateInput>;
  /** Delete currently connected Plan document */
  delete?: InputMaybe<Scalars['Boolean']>;
  /** Disconnect currently connected Plan document */
  disconnect?: InputMaybe<Scalars['Boolean']>;
  /** Update single Plan document */
  update?: InputMaybe<PlanUpdateWithNestedWhereUniqueInput>;
  /** Upsert single Plan document */
  upsert?: InputMaybe<PlanUpsertWithNestedWhereUniqueInput>;
};

export type PlanUpdateWithNestedWhereUniqueInput = {
  /** Document to update */
  data: PlanUpdateInput;
  /** Unique document search */
  where: PlanWhereUniqueInput;
...
export type PlanUpsertWithNestedWhereUniqueInput = {
  /** Upsert data */
  data: PlanUpsertInput;
  /** Unique document search */
  where: PlanWhereUniqueInput;
};

/** This contains a set of filters that can be used to compare values internally */
export type PlanWhereComparatorInput = {
  /** This field can be used to request to check if the entry is outdated by internal comparison */
  outdated_to?: InputMaybe<Scalars['Boolean']>;
};
...
/** The document in stages filter allows specifying a stage entry to cross compare the same document between different stages */
export type PlanWhereStageInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<PlanWhereStageInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<PlanWhereStageInput>>;
  /** Logical OR on all given filters. */
  OR?: InputMaybe<Array<PlanWhereStageInput>>;
  /** This field contains fields which can be set as true or false to specify an internal comparison */
  compareWithParent?: InputMaybe<PlanWhereComparatorInput>;
  /** Specify the stage to compare with */
  stage?: InputMaybe<Stage>;
};

/** References Plan record uniquely */
...
export type Query = {
  ...
  plan?: Maybe<Plan>;
  /** Retrieve document version */
  planVersion?: Maybe<DocumentVersion>;
  /** Retrieve multiple plans */
  plans: Array<Plan>;
  /** Retrieve multiple plans using the Relay connection interface */
  plansConnection: PlanConnection;
...
export type ScheduledOperationAffectedDocument = Asset | Author | Member | Plan;
...
export type GetPlansByAuthorQuery = { __typename?: 'Query', plans: Array<{ __typename?: 'Plan', days: number, expenses: any, transportation: any, location: any, likes?: any | null, images: Array<{ __typename?: 'Asset', id: string }> }> };
...
export const GetPlansByAuthorDocument = gql`
    query GetPlansByAuthor($email: String!) {
  plans(where: {author: {member: {email: $email}}}) {
    days
    expenses
    transportation
    location
